...
* [xs] Allow video trailers to be played in full-screen using the YouTubePlayerView from the details screen.
...
A few things with android API's in that we had a more updated software than that of the bounds of our app. We a quick change of number. however, it was solved.
